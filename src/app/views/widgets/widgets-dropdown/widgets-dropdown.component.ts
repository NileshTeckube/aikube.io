...
export class WidgetsDropdownComponent implements OnInit, OnDestroy, AfterContentInit {

  val: any = null;
  private valSubscription: Subscription | undefined;
  ...
  ngOnInit(): void {
    this.authService.getValObservable().subscribe(
      (newVal) => {
        try {
